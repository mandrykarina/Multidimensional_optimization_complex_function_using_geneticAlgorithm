...
Критерий качества: сопоставление с точным минимумом 0 и случайным поиском. Результат хорош относительно baseline, но недостаточен, если заказчик требует, например, $f(x)<10^{-6}$ в каждом запуске.
